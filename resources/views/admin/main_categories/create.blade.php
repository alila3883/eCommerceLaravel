                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('main_categories.store') }}"
                                              method="POST"
                                                ...
                                                @if(get_languages()->count() > 0)
                                                    @foreach(get_languages() as $index => $lang)
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="name"> اسم القسم - {{ __('messages.'. $lang->abbr) }} </label>
                                                                    <input type="text" value="" id="name"
                                                                           class="form-control"
                                                                           placeholder="{{ $lang->abbr == 'ar' ? 'مثال ملابس' : 'مثال clothing' }}"
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    <label for="abbr"> أختصار اللغة {{__('messages.'. $lang->abbr)}} </label>
