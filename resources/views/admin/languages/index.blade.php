                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="javascript:void(0);" onclick="if (confirm('Are You sure want to Delete?'))
                                                                    { document.getElementById('language-delete-{{ $language->id }}').submit(); } else { return false; }"
                                                                   title="Delete" class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1">حذف</a>
                                                                <form action="{{ route('languages.destroy', $language->id) }}" method="post" id="language-delete-{{ $language->id }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
